from PySide6.QtWidgets import QVBoxLayout,QLabel, QStackedWidget
from PySide6.QtCore import Qt, QTimer
from HelperServices.ColorManagementService import ColorManagementService
from Widgets.InfoWidgets.SingleMeasurementInfoWidget import SingleMeasurementInfoWidget
...
from Widgets.PlotWidgets.SinglePlotWidget import SinglePlotWidget


class SingelementsWidget(MeasurementsWidgetBase):
    def __init__(self,view_model:SingleMeasurementViewModel):
    ...
    def init_plot_section(self):
        self.plot_widget = SinglePlotWidget(self._view_model)
    ...
    def init_information_labels(self):
        self.infoWidget = SingleMeasurementInfoWidget(self._view_model.station_id, self._view_model.measurement_df)
        self.layout.addWidget(self.infoWidget, 0)

        if self._view_model.measurement_df is None or self._view_model.measurement_df.empty:
