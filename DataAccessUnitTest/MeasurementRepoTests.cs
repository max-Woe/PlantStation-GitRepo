...
namespace DataAccessUnitTest
{
    ...
    public class MeasurementRepoTests
    {
        ...
        #region // Hilfsklassen f�r das Testen von EF Core asynchronen Methoden
        public class TestAsyncQueryProvider<TEntity> : IAsyncQueryProvider
        {
            ...
            {
                // Die Methode sollte ein IQueryable<T> zur�ckgeben
                // Dies erfordert, dass die Methode den Ausdruck in eine
                // abfragbare Form �bersetzt
        ...
        public class Update : MeasurementRepoTests
        {
            ...
            // Neuer Test: Update gibt Null zur�ck, wenn Messung nicht gefunden wird
            [Fact]
            ...
            // Neuer Test: Update gibt Null zur�ck bei Ausnahme
            [Fact]
        ...
        public class Delete : MeasurementRepoTests
        {
            ...
            public async Task DeleteById_DoesNotRemove_WhenNotFound()
            {
                ...
                _contextMock.Verify(x => x.SaveChangesAsync(CancellationToken.None), Times.Never); // Hier von 'Once' auf 'Never' �ndern
            }
